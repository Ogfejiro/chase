...
const STATUS_CONFIG = {
  ACTIVE:    { color: "#00ff88", label: "Currently Working Together", dot: "animate-pulse" },
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      [[0,1],[1,2],[0,2]].forEach(([a, b]) => {
        ...
        ctx.strokeStyle = "rgba(0,255,136,0.07)"; ctx.lineWidth = 1; ctx.stroke(); ctx.setLineDash([]);
        ...
        ctx.beginPath(); ctx.arc(px, py, 2, 0, Math.PI * 2); ctx.fillStyle = "rgba(0,255,136,0.9)"; ctx.fill();
      });
  ...
  return (
    <div ref={cardRef} className={`reveal ${delayClass} relative z-10`} style={{ perspective: "900px" }}>
      ...
      >
        ...
        {/* ── FRONT ── */}
        <div
          className="absolute inset-0 border border-[rgba(0,255,136,0.13)] hover:border-[rgba(0,255,136,0.35)] bg-[rgba(4,8,15,0.85)] transition-all duration-300 group overflow-hidden"
          style={{ backfaceVisibility: "hidden" }}
        >
          {/* Status bar */}
          <div className="flex items-center justify-between px-4 py-2.5 border-b border-[rgba(0,255,136,0.08)]">
            <span style={{ fontFamily: "var(--font-mono,'Space Mono',monospace)", fontSize: "9px" }} className="text-[rgba(0,255,136,0.4)] tracking-widest">
          ...
          <div className="relative w-full h-48 border-b border-[rgba(0,255,136,0.08)] overflow-hidden bg-[rgba(0,255,136,0.03)]">
            {collab.image ? (
              <img
                src={collab.image}
                alt={collab.name}
              ...
              <div className="w-full h-full flex flex-col items-center justify-center gap-3">
                <div className="w-16 h-16 rounded-full border-2 border-dashed border-[rgba(0,255,136,0.2)] flex items-center justify-center">
                  <svg viewBox="0 0 24 24" fill="none" className="w-7 h-7" stroke="rgba(0,255,136,0.3)" strokeWidth="1.5">
                    <circle cx="12" cy="8" r="4" />
                    <path d="M4 20c0-4 3.6-7 8-7s8 3 8 7" />
                  </svg>
                </div>
                <span style={{ fontFamily: "var(--font-mono,'Space Mono',monospace)", fontSize: "8px" }} className="text-[rgba(0,255,136,0.25)] tracking-widest uppercase">
                  Add image → public/images/collab-{index + 1}.jpg
                </span>
              </div>
            )}
            {/* Green tint overlay */}
            <div className="absolute inset-0 bg-gradient-to-t from-[rgba(4,8,15,0.7)] via-transparent to-transparent" />
          </div>

          {/* Name + role */}
          <div className="px-4 pt-4 pb-2">
            <div style={{ fontFamily: "var(--font-display,'Bebas Neue',cursive)", fontSize: "clamp(22px,3vw,30px)", lineHeight: 1, letterSpacing: "0.06em" }} className="text-white group-hover:text-[#00ff88] transition-colors duration-300">
              {collab.name}
            </div>
          ...
          <div className="px-4 pb-4">
            <span style={{ fontFamily: "var(--font-mono,'Space Mono',monospace)", fontSize: "9px" }} className="text-[rgba(0,255,136,0.5)] border border-[rgba(0,255,136,0.15)] px-2 py-0.5 tracking-wider">{collab.domain}</span>
          </div>

          <div style={{ fontFamily: "var(--font-mono,'Space Mono',monospace)", fontSize: "8px" }} className="absolute bottom-2.5 right-4 text-[rgba(0,255,136,0.25)] tracking-widest group-hover:text-[rgba(0,255,136,0.5)] transition-colors">
        ...
        {/* ── BACK ── */}
        <div
          className="absolute inset-0 border border-[rgba(0,255,136,0.3)] bg-[rgba(0,18,8,0.97)] p-5 flex flex-col justify-between"
          style={{ backfaceVisibility: "hidden", transform: "rotateY(180deg)" }}
        >
          <div>
            <div style={{ fontFamily: "var(--font-mono,'Space Mono',monospace)", fontSize: "9px" }} className="text-[rgba(0,255,136,0.4)] tracking-widest mb-3 uppercase">
          ...
          <div className="flex items-center justify-between mt-4 pt-4 border-t border-[rgba(0,255,136,0.1)]">
            ...
            <span style={{ fontFamily: "var(--font-mono,'Space Mono',monospace)", fontSize: "9px" }} className="text-[rgba(0,255,136,0.3)] tracking-widest">← Tap to go back</span>
          </div>
        </div>
...
export default function Collaborators() {
  ...
  return (
    <section id="network" ref={ref} className="relative border-b border-[rgba(0,255,136,0.08)] overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
          <div className="reveal">
            <h2 style={{ fontFamily: "var(--font-display,'Bebas Neue',cursive)", letterSpacing: "-0.01em" }} className="text-[clamp(40px,6vw,72px)] leading-none text-white">
              Who I&apos;ve <span className="text-[#00ff88]">Collaborated</span> With
            </h2>
            <p style={{ fontFamily: "var(--font-mono,'Space Mono',monospace)", fontSize: "10px" }} className="text-[rgba(0,255,136,0.35)] tracking-widest uppercase mt-3">
        ...
        <div className="reveal reveal-d3 mt-16 border border-[rgba(0,255,136,0.08)] grid grid-cols-2 md:grid-cols-4 divide-x divide-[rgba(0,255,136,0.08)]">
          {[
            ...
            <div key={i} className="px-6 py-5 text-center group hover:bg-[rgba(0,255,136,0.02)] transition-colors">
              <div style={{ fontFamily: "var(--font-display,'Bebas Neue',cursive)", fontSize: "clamp(26px,4vw,38px)", lineHeight: 1 }} className="text-[#00ff88] group-hover:text-white transition-colors">{item.value}</div>
