...
function SignalBar({ level }: { level: number }) {
  ...
  return (
    <div className="h-1 w-full bg-[rgba(0,255,136,0.08)] overflow-hidden">
  ...
  return (
    <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[420px] h-[420px] opacity-[0.18] pointer-events-none hidden xl:block">
      <svg suppressHydrationWarning viewBox="0 0 420 420" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        ...
        <ellipse cx="210" cy="210" rx="190" ry="55" stroke="#00ff88" strokeWidth="0.5" strokeOpacity="0.4" strokeDasharray="4 6">
        ...
        <ellipse cx="210" cy="210" rx="145" ry="70" stroke="#00ff88" strokeWidth="0.6" strokeOpacity="0.5" transform="rotate(-30 210 210)">
        ...
        <ellipse cx="210" cy="210" rx="100" ry="30" stroke="#00ff88" strokeWidth="0.8" strokeOpacity="0.6" transform="rotate(60 210 210)">
        ...
        <polygon points="210,168 243,189 243,231 210,252 177,231 177,189" stroke="#00ff88" strokeWidth="0.8" strokeOpacity="0.5" fill="none">
          <animateTransform attributeName="transform" type="rotate" from="0 210 210" to="360 210 210" dur="18s" repeatCount="indefinite" />
        </polygon>
        <polygon points="210,182 232,194 232,226 210,238 188,226 188,194" stroke="#00ff88" strokeWidth="0.5" strokeOpacity="0.3" fill="none">
        ...
        {Array.from({ length: 12 }, (_, i) => {
          ...
          return <line suppressHydrationWarning key={i} x1={210 + Math.cos(angle) * 195} y1={210 + Math.sin(angle) * 195} x2={210 + Math.cos(angle) * 202} y2={210 + Math.sin(angle) * 202} stroke="#00ff88" strokeWidth="0.8" strokeOpacity="0.4" />;
        })}
      </svg>
    </div>
  );
    ...
    <section id="about" ref={ref} className="relative border-b border-[rgba(0,255,136,0.08)] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-20 md:py-28 grid md:grid-cols-2 gap-16 md:gap-24 items-start">
        ...
        <div>
          <div className="reveal">
            <h2 className="text-[clamp(42px,7vw,80px)] leading-none text-white mb-6" style={{ fontFamily: "var(--font-display,'Bebas Neue',cursive)", letterSpacing: "-0.01em" }}>
              The person<br /><span className="text-[#00ff88]">behind</span><br />the work
            </h2>
          </div>
          <div className="reveal reveal-d1 space-y-5">
            ...
            <p className="text-[rgba(242,237,230,0.65)] leading-[1.9] font-light text-base" style={{ fontFamily: "var(--font-sans,'Cabinet Grotesk',sans-serif)" }}>
              If you need someone who can <span className="text-[#00ff88]">build, grow, and communicate</span> — that&apos;s exactly what I do.
            </p>
          </div>
          <div className="reveal reveal-d2 mt-10">
            <a href="#contact" className="group inline-flex items-center gap-3 no-underline">
              <span style={{ fontFamily: "var(--font-mono,'Space Mono',monospace)" }} className="text-[11px] tracking-widest uppercase text-[#00ff88] group-hover:text-white transition-colors">Work with me</span>
        ...
        <div className="reveal reveal-d1">
          <div style={{ fontFamily: "var(--font-mono,'Space Mono',monospace)" }} className="text-[9px] text-[rgba(0,255,136,0.4)] tracking-widest mb-6 uppercase">
            What I&apos;m good at
          </div>
          <div className="space-y-0 border border-[rgba(0,255,136,0.12)]">
            {SKILLS.map((skill: Skill, i: number) => (
              <div key={i} className="group px-5 py-5 border-b border-[rgba(0,255,136,0.08)] last:border-b-0 hover:bg-[rgba(0,255,136,0.03)] transition-colors duration-200">
                <div className="flex items-start justify-between gap-4 mb-3">
                  <div>
                    <div className="mb-1.5">
                      <span style={{ fontFamily: "var(--font-mono,'Space Mono',monospace)" }} className="text-[9px] text-[rgba(0,255,136,0.4)] tracking-widest">#{skill.code}</span>
                    </div>
                  ...
                  <span className="text-[#00ff88] flex-shrink-0 mt-1" style={{ fontFamily: "var(--font-display,'Bebas Neue',cursive)", fontSize: "22px", lineHeight: 1 }}>{skill.level}%</span>
                </div>
